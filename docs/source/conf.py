...
htmlhelp_basename = 'diagnnosedoc'
...
latex_documents = [
    (master_doc, 'diagnnose.tex', 'diagnnose Documentation',
     'Jaap Jumelet', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'diagnnose', 'diagnnose Documentation',
     author, 'diagnnose', 'One line description of project.',
     'Miscellaneous'),
]
...
autodoc_mock_imports = ['torch', 'skorch', 'torchtext', 'sklearn', 'transformers', 'tqdm', 'dill']
